...
def airinfo():
	htmldata = getdata("https://weather.com/en-IN/forecast/air-quality/l/93abd8d6fd80bd387737620cd320eec9b04b1567bbb2114847e33ab1571895ad")
	soup = BeautifulSoup(htmldata, 'html.parser')
	res_data = soup.find(class_="DonutChart--innerValue--3_iFF AirQuality--extendedDialText--1kqIb").text
	air_data = soup.find_all(class_="DonutChart--innerValue--3_iFF AirQuality--pollutantDialText--2Q50h")
